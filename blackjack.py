...
# WELCOME TO THE BLACKJACK GAME CODE!
...
#  give the info of the card's suits, ranks and values
...
#  the Card Class which will initiate a card with the given suit and rank
...
#  the Deck Class which will create a deck from the given cards
...
#  the Hand Class which will add the cards from deck class to the player's hand
...
This will be done using global variables, so we will then make a Chips class!       '''
...
while True:
    ...
    if player_hand.value <= 21:
        ...
        if dealer_hand.value > 21:
            ...
            # Inform Player of the total amount of chips they currently have 
